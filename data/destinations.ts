...
const IMAGES: Record<string, string> = {
  porto:
    'https://images.unsplash.com/photo-1555881400-74d7acaacd8b?w=800&h=500&fit=crop&q=80',
  lisbon:
    'https://images.unsplash.com/photo-1585208798174-6cedd86e019a?w=800&h=500&fit=crop&q=80',
  paris:
    'https://images.unsplash.com/photo-1502602898657-3e91760cbb34?w=800&h=500&fit=crop&q=80',
  madrid:
    'https://images.unsplash.com/photo-1543783207-ec64e4d95325?w=800&h=500&fit=crop&q=80',
  barcelona:
  ...
  berlin:
    'https://images.unsplash.com/photo-1560969184-10fe8719e047?w=800&h=500&fit=crop&q=80',
  prague:
    'https://images.unsplash.com/photo-1541849546-216549ae216d?w=800&h=500&fit=crop&q=80',
  dublin:
    'https://images.unsplash.com/photo-1549918864-48ac978761a4?w=800&h=500&fit=crop&q=80',
  florence:
    'https://images.unsplash.com/photo-1543429776-2782f8f3e2b4?w=800&h=500&fit=crop&q=80',
  seville:
    'https://images.unsplash.com/photo-1555990538-1f0d74bfba6c?w=800&h=500&fit=crop&q=80',
  istanbul:
